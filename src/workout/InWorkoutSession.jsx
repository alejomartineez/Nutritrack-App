...
function WatermarkHint({ last }) {
  ...
  return (
    <p className="text-xs text-entreno-400/70 italic mt-0.5">
  ...
  return (
    <div
      className={`rounded-xl border p-2 flex items-center gap-1.5 ${
        set.completed ? 'bg-entreno-500/10 border-entreno-500/30' : 'bg-neutral-800/60 border-neutral-700'
      }`}
    >
      ...
      <button
        ...
        className={`shrink-0 w-11 h-9 rounded-lg text-[11px] font-bold flex items-center justify-center ${
          hasRir ? 'bg-entreno-500/20 text-entreno-300 border border-entreno-500/30' : 'text-slate-600 border border-neutral-700'
        }`}
      >
